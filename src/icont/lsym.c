 ...
 */
static struct gentry *alcglobal(struct gentry *blink,
   word name, int flag, int nargs, int procid)
   {
 ...
 */
static struct fentry *alcfhead(struct fentry *blink,
   word name, int fid, struct rentry *rlist)
   {
   register struct fentry *fp;
