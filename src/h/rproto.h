...
int		anycmp		(const void *dp1,const void *dp2);
int		bfunc		(void);
...
word		prescan		(dptr d);
int		pstrnmcmp	(const void *ps1, const void *ps2);
...
int	nthcmp		(const void *d1,const void *d2);
...
int	trcmp3		(const void *dp1, const void *dp2);
int	trefcmp		(const void *d1, const void *d2);
int	tvalcmp		(const void *d1, const void *d2);
int	tvcmp4		(const void *dp1, const void *dp2);
